...
urlpatterns=[
    ...
    path('logdata',views.logdata_fun),#i will read data and verify,user is superuser and redirect to home.html
    path('home',views.home_fun,name='home'),
    path('add_students',views.addstudent_fun,name='add'),
    path('readdata',views.readdata_fun),#i will insert records into studenttable
